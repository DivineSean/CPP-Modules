...
void    ClapTrap::takeDamage( unsigned int amount )
{
    if (this->Hit_Points > amount)
    {
        ...
        std::cout << name << " Now Have " << Hit_Points << "/10 HP" << std::endl;
    }
...
void    ClapTrap::beRepaired( unsigned int amount )
{
    if (this->Hit_Points == 10)
        std::cout << name << " Already Full HP 10/10" << std::endl;
    ...
    else
    {
        ...
        {
            std::cout << "Reducing The Amount " << amount << " To " << 10 - Hit_Points << " For Maximum Health Bar!" <<std::endl;
            amount = 10 - Hit_Points;
        }
        std::cout << name << " Heal " << amount << " Hit_Points!"<< std::endl;
        this->Energy_Points--;
        this->Hit_Points += amount;
        std::cout << name << " Now Have " << this->Hit_Points << "/10 HP" << std::endl;
    }
}
